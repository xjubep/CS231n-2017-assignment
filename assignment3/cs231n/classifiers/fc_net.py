...
def my_normal(mean, std, row, col):
    mat = []
    for i in range(row):
        one_row = []
        for j in range(col):
...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        self.params['W1'] = my_normal(0, weight_scale, input_dim, hidden_dim)
        self.params['b1'] = my_zeros(hidden_dim)
        self.params['W2'] = my_normal(0, weight_scale, hidden_dim, num_classes)
        self.params['b2'] = my_zeros(num_classes)
        ## 문제 1. end block ###############################################################################
    ...
    def loss(self, X, y=None):
        ...
        loss += 0.5 * self.reg * (sum(sum(my_square(self.params['W1']))) + sum(sum(my_square(self.params['W2'])))) 
        ## 문제 2. end block ###############################################################################
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        for i in range(self.num_layers -1):
            self.params['W' + str(i + 1)] = my_normal(0, weight_scale, input_dim, hidden_dims[i])
            self.params['b' + str(i + 1)] = my_zeros(hidden_dims[i])

            if self.use_batchnorm:
                self.params['beta' + str(i + 1)] = my_zeros(hidden_dims[i])
                self.params['gamma' + str(i + 1)] = my_ones(hidden_dims[i])
    ...
    def loss(self, X, y=None):
        ...
        loss += 0.5 * self.reg * sum(sum(my_square(self.params['W' + str(self.num_layers)])))
        ## 문제 4-1. end block #############################################################################
        ...
        for i in range(self.num_layers-1, 0, -1):
            ...
            loss += 0.5 * self.reg * sum(sum(my_square(self.params['W' + str(i)])))
            ## 문제 4-1. end block #############################################################################
